...
This DSL (Domain-Specific Language) is inspired by JSON Patch and follows RFC 6901 for JSON Pointer representation in the path. It consists of an array of objects, each having the following keys:
